...
import (
	...
	"github.com/bclube/proglog/internal/loadbalance"
...
func (*subConn) GetOrBuildProducer(balancer.ProducerBuilder) (p balancer.Producer, close func()) {
	return nil, nil
}

func (*subConn) Shutdown() {}
